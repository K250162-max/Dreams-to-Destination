    ...
    <div className="site-shell" id="top">
      ...
      <main>
        <section className="hero-section" aria-labelledby="hero-title">
          ...
          <div className="page-container hero-layout">
            ...
            >
              <span className="hero-badge">
                <Sparkles size={14} /> Visa · Immigration · Admissions <i>Global guidance</i>
              </span>
              ...
              <p>
                Trusted visa and immigration consultants helping students,
                professionals, families, and travelers move forward with
                clarity, confidence, and a carefully prepared plan.
              </p>
              ...
              <div className="hero-trust-line">
                ...
                <span>
                  <strong>Profile-first guidance</strong>
                  <small>Clear advice before commitment</small>
                </span>

                <i />

                <span>
                  <strong>Worldwide pathways</strong>
                  <small>Study, work, visit, and settle</small>
                </span>
              </div>
            </motion.div>
          ...
          <div
            className="page-container hero-stats"
          ...
          <div className="page-container">
            <div className="section-intro-row">
              ...
              <div className="section-side-note">
                <span>08</span>
                <p>
                  Dedicated advisory pathways, designed around real decisions
        ...
        <section className="section section--paper" id="eligibility">
          <div className="page-container">
            <div className="section-intro-row">
              ...
              <div className="section-side-note section-side-note--blue">
                <Target size={25} />
                <p>
                  Educational guidance only. No algorithm can guarantee an
                  immigration outcome.
                </p>
              </div>
            </div>
        ...
        <section className="section about-section" id="about">
          <div className="page-container about-grid">
            ...
            >
              {/* Local image from client/public/airport-terminal.png */}
              <img
                src="/airport-terminal.webp"
                alt="Airport terminal overlooking the runway at sunset"
                loading="lazy"
                decoding="async"
                width="1200"
                height="800"
              ...
              <div className="about-visual-overlay">
                <span>Since</span>
                <strong>10+</strong>
                <small>years of guided journeys</small>
              </div>
            ...
            <div className="about-copy">
              ...
              <p className="about-lead">
                Our work begins before the application. We listen to the
                ambition behind it, identify a route that fits, explain the
                trade-offs clearly, and organize the journey into manageable
                decisions.
              </p>

              <div className="expertise-signals">
                {expertiseSignals.map(([title, body]) => (
                  <div key={title}>
                    <Check size={15} />
              ...
              <a className="outline-button" href="#consultation">
                Meet your next step <ArrowRight size={16} />
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="section process-section" id="process">
          ...
          <div className="page-container">
            <div className="section-intro-row">
              ...
              <a className="process-link" href="#consultation">
                Start at step one <ArrowUpRight size={17} />
              </a>
            </div>
        ...
        <section className="section consultation-section" id="consultation">
          <div
            className="consultation-orb consultation-orb--one"
            aria-hidden="true"
          />

          <div
            className="consultation-orb consultation-orb--two"
            aria-hidden="true"
          />
          ...
          <div className="page-container consultation-grid">
            <div className="consultation-copy">
              ...
              <h2>
                Bring the profile.
                <br />
                <em>We’ll help define the route.</em>
              </h2>

              <p>
                Tell us what you want to achieve and when. Your request is
                saved securely so our team can review the facts, priorities,
                and practical next steps before confirming a consultation.
              </p>
              ...
              <div className="consultation-points">
                <div>
                  ...
                  <strong>Focused 30-minute review</strong>
                  <small>Goal, profile, route, and next steps.</small>
                </div>
                ...
                <div>
                  ...
                  <strong>No-obligation guidance</strong>
                  <small>Understand your options before committing.</small>
                </div>
                ...
                <div>
                  ...
                  <small>
                    Availability is confirmed using your chosen details.
                  </small>
                </div>
              </div>
          ...
          <div className="page-container faq-grid">
            <div>
              ...
              <div className="faq-aside">
                ...
                <p>Send us the question that is holding you back.</p>
                <a href="#contact">
                  Ask the team <ArrowRight size={15} />
                </a>
              </div>
            </div>
        ...
        <section className="section contact-section" id="contact">
          <div className="page-container contact-grid">
            <div className="contact-copy">
              ...
              <p>
                Contact the team for a service question, a document review
                request, or a conversation about the most realistic next step.
              </p>
              ...
              <div className="location-panel">
                <div className="location-grid-art" aria-hidden="true">
                  <span />
                  <i />
                  <b />
                </div>
            ...
            <div className="enquiry-card">
              <span className="enquiry-kicker">General enquiry</span>
              <h3>How can we help?</h3>
              <p>
                Share a little context and the team will respond by email.
              </p>
      ...
      <footer className="site-footer">
        <div className="footer-station" aria-hidden="true">
          ...
          <div className="footer-station-ring">
            <span />
            <i />
            <b />
          </div>

          <div className="footer-docking-light footer-docking-light--one" />
          <div className="footer-docking-light footer-docking-light--two" />
        </div>
        ...
        <div className="page-container footer-main">
          <div className="footer-brand">
            ...
            <p>
              Personal visa, immigration, and admissions guidance for
              international dreams that deserve a well-prepared route.
            </p>
          ...
          <div className="footer-column">
            ...
            <a href="#services">Visit visas</a>
            <a href="#services">Work visas</a>
            <a href="#services">Permanent residency</a>
          </div>

          <div className="footer-cta">
            <small>Destination notes</small>
            <h3>Useful guidance, thoughtfully sent.</h3>
        ...
        <div className="page-container footer-bottom">
          <span>
            © {new Date().getFullYear()} Dreams To Destination. All rights
            reserved.
          </span>
